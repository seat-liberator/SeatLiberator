...
public class ReservationTest {
    ...
    class TransitionFromReserved {
        ...
        void use_reserved_reservation() {
            var reservation = ReservationFixture.next();
            var usedAt = clock.instant().plusSeconds(1);
        ...
        void cancel_reserved_reservation() {
            var reservation = ReservationFixture.next();
            var cancelledAt = clock.instant().plusSeconds(1);
        ...
        void expire_reserved_reservation() {
            var reservation = ReservationFixture.next();
            var expiredAt = clock.instant().plusSeconds(1);
    ...
    class TransitionFromUsed {
        ...
        void can_not_use_already_used_reservation() {
            var reservation = ReservationFixture.nextWithStatus(ReservationStatus.USED);

            assertThatThrownBy(() -> reservation.use(clock.instant().plusSeconds(2)))
        ...
        void can_not_cancel_used_reservation() {
            ...
            assertThatThrownBy(() -> reservation.cancel(clock.instant().plusSeconds(2)))
                    .isInstanceOf(IllegalStateException.class)
                    .hasMessage("이미 사용된 예약입니다.");
        ...
        void can_not_expire_used_reservation() {
            ...
            assertThatThrownBy(() -> reservation.expire(clock.instant().plusSeconds(2)))
                    .isInstanceOf(IllegalStateException.class)
                    .hasMessage("이미 사용된 예약입니다.");
    ...
    class TransitionFromCancelled {
        ...
        void can_not_use_cancelled_reservation() {
            var reservation = ReservationFixture.nextWithStatus(ReservationStatus.CANCELLED);
    ...
    class TransitionFromExpired {
        ...
        void can_not_use_expired_reservation() {
            var reservation = ReservationFixture.nextWithStatus(ReservationStatus.EXPIRED);
