...
public class ReservationCancelAuthorizer {
    ...
    public PolicyResult evaluate(Actor actor) {
        ...
        if (capabilities.contains(ReservationCapability.OWNED_BOOKING_CANCEL))
            return SimplePolicyResult.accept(ReservationPolicyReason.AUTHORIZED_RESERVATION_CANCEL);
