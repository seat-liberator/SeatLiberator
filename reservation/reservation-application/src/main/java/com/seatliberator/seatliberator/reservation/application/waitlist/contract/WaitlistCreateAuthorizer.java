...
public class WaitlistCreateAuthorizer {
    ...
    public PolicyResult evaluate(Actor actor) {
        ...
        if (capabilities.contains(ReservationCapability.WAITLIST_CREATE))
            return SimplePolicyResult.accept(WaitlistPolicyReason.AUTHORIZED_WAITLIST_CREATE);

        return SimplePolicyResult.reject(WaitlistPolicyReason.UNAUTHORIZED_WAITLIST_CREATE);
    }
}
