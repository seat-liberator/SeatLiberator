...
@DisplayName("DefaultExecutionStateTest - Constructor / Factory")
public class DefaultExecutionStateConstructorAndFactoryTest {
    @Test
    ...
    void of는_기존_ExecutionState를_DefaultExecutionState로_복사한다() {
        ...
        ExecutionState source = DefaultExecutionState.resolved(
                2,
                tryStartAt,
                resolvedAt,
                output
        ...
        DefaultExecutionState copied = DefaultExecutionState.of(source);
